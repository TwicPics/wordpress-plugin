...
Contributors:
Donate link:
Tags: image optimization, adaptive image compression, resize image, responsive image generation, optimize image, performance optimization, page speed, next-gen format, convert WebP, lazy loading, DPR, SEO optimization, CDN
Requires at least: 5.0
Tested up to: 5.6
Requires PHP:
Stable tag: 0.1.0
License: gpl-2.0
License URI: [http://www.gnu.org/licenses/old-licenses/gpl-2.0.txt](http://www.gnu.org/licenses/old-licenses/gpl-2.0.txt)

Boost your website performance and SEO by delivering pixel perfect images on the fly to any type of device.
...
TwicPics' library being the heart of this WordPress plugin means **you don't have anything to do regarding your images optimization:** it handles everything for you by automatically requesting to the API the correct transformations to apply to your images, depending on the visitor's device.
...
- **SEO optimization**
- And some extra features available from your admin dashboard !
...
3. **Plugin settings**
    ...
    - Navigate to TwicPics settings to enter your **TwicPics domain**, so the plugin can be able to know who you are.

        You can find these settings at two levels on your WordPress **admin menu**: at the **top-level menu** and at `**Media` sub-level menu**

        ![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8a44ad1a-0fbd-4227-b864-6604c29f8424/Untitled.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8a44ad1a-0fbd-4227-b864-6604c29f8424/Untitled.png)
